    ...
    <div class="overlay-kofan">
      <div class="container text-center py-5">
        <font-awesome-icon
          ...
          class="text-success mb-3 fs-1"
        />
        <h1 class="display-4 fw-bold text-white mb-2">Experiencias Kofán</h1>
        <p class="text-light lead mb-5">
          Elige el tipo de experiencia que deseas vivir en el corazón del
          Putumayo
        </p>
...
const goToHospedaje = () => {
  // Aquí redireccionas a la vista de Cabañas que me pasaste
  router.push("/servicios/hospedaje");
};
</script>
...
.service-selection {
  margin-top: 60px;
  min-height: 100vh;
  background-image: url("https://i0.wp.com/www.lasillavacia.com/wp-content/uploads/2023/10/LaPaya_Portada.jpg?fit=1200%2C700&ssl=1"); /* Una imagen general de la maloka o selva */
...
.overlay-kofan {
  min-height: 100vh;
  background: rgba(15, 59, 42, 0.8); /* Verde Kofán con transparencia */
  display: flex;
  align-items: center;
}
